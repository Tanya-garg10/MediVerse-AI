...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MediVerse AI — AI-Powered Healthcare Platform" },
      {
        name: "description",
        content:
          "MediVerse AI is an AI-powered healthcare platform for patients, doctors, hospitals and researchers.",
      },
      { name: "theme-color", content: "#12101f" },
      { property: "og:site_name", content: "MediVerse AI" },
